...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <!--jQuery-->
        {{-- <script type="text/javascript" src="{{ asset('backend') }}/assets/js/jquery-3.7.1.min.js"></script> --}}

        <!-- For icon visit this site: https://remixicon.com/ -->
    </head>
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
        ...
        <!--toastr js-->
        <script src="{{ asset('backend') }}/assets/js/toastr.min.js" type="text/javascript"></script>
        ...
        <!--Validate JS-->
        <script src="{{ asset('backend') }}/assets/js/validate.min.js" type="text/javascript"></script>
