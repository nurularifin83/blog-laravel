...
@section('main')
@section('title')
Category - {{config('app.name', 'Laravel') }}
@endsection
<!-- breadcrumb-area -->
                ...
                <div class="standard__blog__post">
                    ...
                    <div class="standard__blog__content">
                        <div class="blog__post__avatar">
                            <div class="thumb"><img src="{{ empty($post->profile_image) ? url('upload/no_image.jpg') : url('upload/admin_images/'.$post->profile_image) }}" 
                                alt="{{ $post->user_name }}" alt=""></div>
