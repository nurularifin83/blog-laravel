...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <!--toastr js-->
        <script src="{{ asset('frontend') }}/assets/js/toastr.min.js" type="text/javascript"></script>
        <!--Validate JS-->
        <script src="{{ asset('frontend') }}/assets/js/validate.min.js" type="text/javascript"></script>
        <!--JS Custome-->
