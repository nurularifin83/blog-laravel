        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-8 col-md-10">
                <div class="breadcrumb__wrap__content">
                    <h2 class="title">{{ $portfolioDetail->portfolio_name }}</h2>
    ...
    <div class="breadcrumb__wrap__icon">
        <ul>
            @foreach ($multiImages as $multiImage)
                <li><img src="{{ $multiImage->multi_image === NULL ? url('upload/no_image.jpg') : url($multiImage->multi_image)  }}" alt=""></li>
            @endforeach
        </ul>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="services__details__thumb">
                    <img src="{{ url($portfolioDetail->portfolio_image)  }}" alt="{{ $portfolioDetail->portfolio_name }}">
                </div>
                <div class="services__details__content">
                    <h2 class="title">{{ $portfolioDetail->portfolio_title }}</h2>
                    <p>
                        {!! $portfolioDetail->portfolio_description !!}
                    </p>
                </div>
            </div>
            <div class="col-lg-4">
